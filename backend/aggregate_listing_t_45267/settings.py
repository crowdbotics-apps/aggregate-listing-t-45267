"""
Django settings for aggregate_listing_t_45267 project.
...
ROOT_URLCONF = 'aggregate_listing_t_45267.urls'
...
WSGI_APPLICATION = 'aggregate_listing_t_45267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aggregate_listing_t_45267 API",
    "DESCRIPTION": "API documentation for aggregate_listing_t_45267 App",
    "VERSION": "v1",
}
